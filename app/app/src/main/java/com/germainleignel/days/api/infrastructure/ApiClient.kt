...
import com.germainleignel.days.api.auth.ApiKeyAuth
...
import com.germainleignel.days.api.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth: Interceptor? = when (authName) { 
                "BearerAuth" -> ApiKeyAuth("header", "Authorization")
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey: String = "com.germainleignel.days.api.baseUrl"
