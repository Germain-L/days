...
class ServicesCreateUserRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ServicesCreateUserRequest
        //val modelInstance = ServicesCreateUserRequest()
